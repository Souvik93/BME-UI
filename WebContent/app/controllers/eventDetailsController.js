...
routerApp.controller('eventDetailsController', function($scope,$location,$state,$stateParams,PostService,SearchService,$rootScope,$http){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $scope.commentOnEvent = function(commentsBox){
        ...
        $scope.commentsURL = "http://DIN52002773:9999/BME/showDislikes'+'?name="
            //console.log($scope.commentsURL);
            PostService(callbackForComments,$scope.commentsURL,commentsBox);

            function callbackForComments(data){
                /*console.log("IN CALL BACK OF COMMENTS");*/
                $rootScope.comments =  data;
                console.log("comment added "+$rootScope.comments);
            };
  ...
  /*  $scope.commentsURL = 'http://localhost:1111/BME/saveComment'
    //console.log($scope.commentsURL);
